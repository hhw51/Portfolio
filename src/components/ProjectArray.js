...
const projectArray = [
  ...
  },
  {
    ...
    description:
      "An admin dashboard project made using MERN. It can be attached to any e-commerce website using Firebase or MongoDB.",
    demoLink: "https://dashboard-rose-nu-45.vercel.app/",
  },
  {
    imgPath: Images.graphqlProject,
    title: "GraphQL Practice Project",
    description:
      "A simple client and project management website made using MERN along with GraphQL. Users can add clients, delete clients, add projects for specific clients, and update projects.",
    demoLink: "https://graph-ql-client.vercel.app/",
  },
  {
    imgPath: Images.jobDashboard,
    title: "Job Dashboard",
    description:
      "A job dashboard made using Next.js and Firebase as a backend. A user can add different jobs, applications, and recruiters. Users can also select the status of jobs or recruiters, among other functionalities.",
